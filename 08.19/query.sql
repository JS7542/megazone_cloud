...
('mzc-000', '1111', '김유신', 'adc@mz.co.kr', '010-1111-1111', '서울특별시 강남구 논현로', '메가존빌딩 101호', '2002-07-26',2, now()),
('mzc-111', '1111', '이순신', 'bcd@mz.co.kr', '010-2222-2222', '서울특별시 강남구 강남대로', '제니스빌딩 210호', '2002-07-26',2, now()),
('mzc-333', '1111', '홍길동', 'cde@mz.co.kr', '010-3333-3333', '서울특별시 강남구 삼성로', '금정빌딩 310호', '2002-07-26',2, now()),
('mzc-444', '1111', '강감찬', 'def@mz.co.kr', '010-4444-4444', '서울특별시 강남구 역삼동', '빅데이터빌딩 410호', '2002-07-26',2, now()),
('mzc-555', '1111', '세종', 'efg@mz.co.kr', '010-5555-5555', '서울특별시 강남구 청담동', '에이아이빌딩 510호', '2002-07-26',2, now()),
('mzc-666', '1111', '정조', 'fgh@mz.co.kr', '010-6666-6666', '경기도 수원시', '아이오티빌딩 610호', '2002-07-26',2, now()),
('mzc-777', '1111', '김종신', 'ghi@mz.co.kr', '010-7777-7777', '경기도 의정부시', '스마트시티빌딩 710호', '2002-07-26',2, now()),
('mzc-888', '1111', '아이유', 'hij@mz.co.kr', '010-8888-8888', '경기도 안양시', '클라우드빌딩 810호', '2002-07-26',2, now()),
('mzc-999', '1111', '안중근', 'ijk@mz.co.kr', '010-9999-9999', '경기도 군포시', '그램빌딩 210호', '2002-07-26',2, now()),
('adc-tot', '2222', '애쓴이', 'lmn@megazone.com', '010-0000-0000', '경기도 화성시', '메가존빌딩 2층', '2004-05-21', '1', now());
SELECT * FROM TMEMBER;
##################################################################################
